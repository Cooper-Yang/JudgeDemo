...
public class ManualController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        LeftList.Add("Routines:\nCongratulations on becoming the backbone of our party. The following will explain the specific instructions " +
            ...
            "to find evidence and print it out. The printed material is on the evidence board behind the computer.(...");
        LeftList.Add("(Applications, please refer to the computer's guide)");
